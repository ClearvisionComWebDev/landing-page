...
const Services = () => {
    return (
        <section id="two" style={{backgroundColor:"#95c3ff",borderBottom:"5px solid #00142e"}} classname="wrapper style2 spotlights">
        <div classname="inner" style={{padding:"40px"}}>
        <h1 style={{color:"#00142e", fontFamily:"Helvetica"}}>OUR SERVICES</h1>
